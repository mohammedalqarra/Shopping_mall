...
@section('content')
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea name="content_en" placeholder="English name" rows="10" class="myeditor"></textarea>
        </div>
        <div class="mb-3">
            <label>Arabic content</label>
            <textarea name="content_ar" placeholder="Arabic name" rows="10" class="myeditor"></textarea>
        </div>
        <div class="row">
            <div class="col-md-4">
                <div class="mb-3">
