...
<body>
                    ...
                    <g class="b" transform="translate(25 -58)">
                        <g class="c" transform="translate(-585.529 331.726)">
                            <path class="d"
                                ...
                                transform="translate(-317.723 -288.325)"></path>
                            <path class="e"
                                ...
                                transform="translate(-298.268 -234.833)"></path>
                        ...
                        <g class="c" transform="translate(-743.926 354.582)">
                            <path class="g"
                                ...
                                transform="translate(-313.715 -344.568)"></path>
                            <path class="h"
                                ...
                                transform="translate(-298.327 -266.489)"></path>
                        ...
                        <g class="c" transform="translate(-1046.649 464.919)">
                            <path class="g"
                                d="M330,687.576V354.422S631.107,685.647,878.452,698.112c275.977-2.807,278.239-171.952,520.751-264.548,203.024-72.706,357.942,125.622,527.763,130.459s287.023-135.926,518.71-145.705c300.179,14.727,541.051,202.792,559.742,212.9V768.716L330,768.958Z"
                                transform="translate(-314.715 -344.568)"></path>
                            <path class="h"
                                d="M312.953,279.164S623.431,616.493,866.082,619.648s325.629-198.754,520.459-266.824,363.846,129.84,526.511,132.324,318.406-148.686,518.271-144.577S2859.7,459.03,2986.03,549.234"
                                transform="translate(-298.327 -266.489)"></path>
            ...
            <div class="sign-up__content">
                ...
                <form class="sign-up__form form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form__row">
                        <div class="input">
                            <div class="input__container">
                                <input class="input__field" id="name" placeholder="name" type="text"
                                    name="name" value="{{ old('name') }}" required="" /><label
                                    class="input__label" for="username">Name</label>
                                @error('name')
                                    <small style="color: red" role="alert">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="input">
                            <div class="input__container">
                                <input class="input__field" id="email" placeholder="Email" required=""
                                    type="text" name="email" value="{{ old('email') }}" /><label
                    ...
                    <div class="form__row">
                        <div class="input">
                            <div class="input__container">
                                <input class="input__field" id="password" name="password" placeholder="Password"
                                    required="" type="password" /><label class="input__label"
                        ...
                        <div class="input">
                            <div class="input__container">
                                <input class="input__field" id="confirm-password" placeholder="Confirm password"
                                    required="" type="password" name="password_confirmation" /><label
                                    class="input__label" for="confirm-password">Confirm password</label>
                            </div>
                        </div>
                    </div>
                    <div class="form__row">
                        <div class="input-checkbox">
                            <div class="input-checkbox__container">
                                <input checked="" class="input-checkbox__field" id="agree" required=""
                                    tabindex="0" type="checkbox" /><span
                                    class="input-checkbox__square"></span><label class="input-checkbox__label"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var checkValidForm = () => {
                if (_.every(requiredInput, input => {
