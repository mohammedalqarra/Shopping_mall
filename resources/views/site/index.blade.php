                                    ...
                                    <div class="col-sm-3 col-xs-12">
                                        <a href="shop.html">
                                            <img class="img-responsive"
                                                src="{{ asset('siteassets/images/shop/header-img.jpg') }}"
                                                alt="menu image" />
                                        </a>
                                    </div>
                                </div><!-- / .row -->
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="category-box">
                        <a href="#!">
                            <img src="{{ asset('siteassets/images/shop/category/category-1.jpg') }}"
                                alt="" />
                            <div class="content">
                                <h3>Clothes Sales</h3>
                    ...
                    <div class="category-box">
                        <a href="#!">
                            <img src="{{ asset('siteassets/images/shop/category/category-2.jpg') }}"
                                alt="" />
                            <div class="content">
                                <h3>Smart Casuals</h3>
                ...
                <div class="col-md-6">
                    <div class="category-box category-box-2">
                        <a href="#!">
                            <img src="{{ asset('siteassets/images/shop/category/category-3.jpg') }}"
                                alt="" />
                            <div class="content">
                                <h3>Jewellery</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <div class="product-thumb">
                            ...
                            <img class="img-responsive"
                                src="{{ asset('siteassets/images/shop/products/product-1.jpg') }}"
                                alt="product-img" />
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img class="img-responsive"
                                src="{{ asset('siteassets/images/shop/products/product-2.jpg') }}"
                                alt="product-img" />
                            <div class="preview-meta">
                                <ul>
                                    <li>
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img class="img-responsive"
                                src="{{ asset('siteassets/images/shop/products/product-3.jpg') }}"
                                alt="product-img" />
                            <div class="preview-meta">
                                <ul>
                                    <li>
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img class="img-responsive"
                                src="{{ asset('siteassets/images/shop/products/product-4.jpg') }}"
                                alt="product-img" />
                            <div class="preview-meta">
                                <ul>
                                    <li>
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img class="img-responsive"
                                src="{{ asset('siteassets/images/shop/products/product-5.jpg') }}"
                                alt="product-img" />
                            <div class="preview-meta">
                                <ul>
                                    <li>
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img class="img-responsive"
                                src="{{ asset('siteassets/images/shop/products/product-6.jpg') }}"
                                alt="product-img" />
                            <div class="preview-meta">
                                <ul>
                                    <li>
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <div class="product-thumb">
                            <span class="bage">Sale</span>
                            <img class="img-responsive"
                                src="{{ asset('siteassets/images/shop/products/product-7.jpg') }}"
                                alt="product-img" />
                            <div class="preview-meta">
                                <ul>
                                    <li>
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img class="img-responsive"
                                src="{{ asset('siteassets/images/shop/products/product-8.jpg') }}"
                                alt="product-img" />
                            <div class="preview-meta">
                                <ul>
                                    <li>
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <div class="product-thumb">
                            <img class="img-responsive"
                                src="{{ asset('siteassets/images/shop/products/product-9.jpg') }}"
                                alt="product-img" />
                            <div class="preview-meta">
                                <ul>
                                    <li>
